...
const ExercisePage = () => {
  ...
  return (
    <div
    >
      <h2 className="head1" style={{textAlign:"center"}}>Search For A Perfect Exercise</h2>
      <div className="menu">
        <div className="menu-item">
          <select value={selectedMuscle} onChange={handleMuscleChange} className="dropdown">
        ...
        <button onClick={handleSearch} className="search-btn"><b>SEARCH</b></button>
      </div>
